                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <p class="mb-4">Email adresinizi girdiğiniz zaman size tek seferlik siteye girmenizi sağlayacak şifre göndereceğiz.Lütfen şifrenizi hesabınızı girdikten sonra şifrenizi güncelleyiniz./p>
                                </div>
                                <form class="user" action="{{route('isExist.Email')}}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Email adresini giriniz...">
                                    </div>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="{{route('register.view')}}">Kayıt Ol</a>
                                </div>
                                <div class="text-center">
