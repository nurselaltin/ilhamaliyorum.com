...
<div class="header-container">
                ...
                <div class="col-xs-3 col-sm-6 col-md-9">
                    ...
                    <div class="header-top-first clearfix">
                        <ul class="list-inline hidden-sm hidden-xs">
                            <li><i class="fa fa-envelope-o pr-5 pl-10"></i>ilhamaliyorum@gmail.com</li>
                        </ul>
                    </div>
    ...
    <!-- ================ -->
    <header class="header centered fixed    clearfix"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
