            ...
            <div id="slider-banner-fullscreen" class="slider-banner-fullscreen rev_slider" data-version="5.0">
                <ul class="slides">
                    ...
                    <li class="text-center" data-transition="random" data-slotamount="default" data-masterspeed="default" data-title="">
                        ...
                        <!-- main image -->
                        <img src="<?php echo base_url('assets');?>/images/cosmos.jpg" alt="slidebg1" data-bgposition="center center" data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                        ...
                        <div class="tp-caption xlarge_white"
                             ...
                             data-transform_out="x:[-50%];o:0;s:200;e:Power2.easeInOut;"
                             data-mask_in="x:0;y:0;s:inherit;e:inherit;"
                             data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">Okumak
                        </div>
                        ...
                        <div class="tp-caption xlarge_white"
                             ...
                             data-mask_in="x:0;y:0;s:inherit;e:inherit;"
                             data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">Anlamak
                        </div>
                        ...
                        <div class="tp-caption medium_white"
                             ...
                             data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">Bilgiyi aktarmadığın zaman o senin sırtında yüktür.
                        </div>
                    ...
                    <!-- slide 2 start -->
                    <!-- ================ -->
                    <li data-transition="random" data-slotamount="7" data-masterspeed="default" data-title="">

                        <!-- main image -->
                        <img src="<?php echo base_url('assets');?>/images/home_banner.jpg" alt="slidebg2" data-bgposition="center center" data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
